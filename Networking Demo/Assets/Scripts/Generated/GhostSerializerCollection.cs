...
public struct CubeGhostSerializerCollection : IGhostSerializerCollection
{
    ...
    public int Serialize(SerializeData data)
    {
        switch (data.ghostType)
        {
            case 0:
            {
                return GhostSendSystem<CubeGhostSerializerCollection>.InvokeSerialize<CubeGhostSerializer, CubeSnapshotData>(m_CubeGhostSerializer, data);
            }
            default:
                throw new ArgumentException("Invalid serializer type");
        }
...
public struct EnableCubeGhostSendSystemComponent : IComponentData
{}
public class CubeGhostSendSystem : GhostSendSystem<CubeGhostSerializerCollection>
{
    protected override void OnCreate()
    {
        base.OnCreate();
        RequireSingletonForUpdate<EnableCubeGhostSendSystemComponent>();
    }
}
